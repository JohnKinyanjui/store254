...
GO_APP_NAME="store_public_api"             # Replace with your app's name
GO_APP_DIR="$DIR/store254_backend/bin/public"        # Replace with your app's directory
GO_APP_COMMAND="main"  
...
autostart=true
autorestart=true
stderr_logfile=/var/log/store_public.err.log
stdout_logfile=/var/log/store_public.out.log
EOF
