<script lang="ts">
    ...
    import PaymentDeleteDialog from "../payments/PaymentDeleteDialog.svelte";
    import PaymentEditDialog from "../payments/PaymentEditDialog.svelte";
...
>
    ...
    <div class="flex flex-col space-x-3">
        <p class={`font-medium text-[12px] text-gray-500 line-clamp-2`}>
            {method.description}
        </p>
    </div>
    <div class="flex flex-row justify-between items-center">
        <div class="flex flex-row space-x-2">
            <PaymentEditDialog form={form ?? null} {method} />
